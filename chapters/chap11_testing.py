...
def run():
    ...
    left_wall.material.colour = Colour(0.5, 0.5, 0.5)
    left_wall.material.specular = 0
    left_wall.material.reflective = 0.2
    left_wall.material.pattern = left_wall_pattern

    right_wall = Plane()
    right_wall_pattern = DoubleGradientPattern(Colour(1, 0, 0), Colour(0, 1, 1))
    ...
    middle.material.colour = Colour(0.1, 0.1, 0.1)
    ...
    right.material.colour = Colour(0, 0, 0.3)
    right.material.diffuse = 0.7
    right.material.specular = 0.3
    right.material.reflective = 0.3
    right.material.transparency = 0.7
    ...
    left = Sphere()
    left.transform = Matrix.translation(-1, 0.8, -0.75) * Matrix.scaling(0.8, 0.8, 0.8) #* \
    ...
    left.material.refractive_index = 2
